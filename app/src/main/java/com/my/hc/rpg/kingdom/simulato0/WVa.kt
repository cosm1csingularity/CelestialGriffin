...
import com.my.hc.rpg.kingdom.simulato0.Constants.CAMP2
import com.my.hc.rpg.kingdom.simulato0.Constants.CAMP3
import com.my.hc.rpg.kingdom.simulato0.Constants.DEEP1
import com.my.hc.rpg.kingdom.simulato0.Constants.DEEP2
import com.my.hc.rpg.kingdom.simulato0.Constants.DEEP3
import com.orhanobut.hawk.Hawk
import java.io.File
import java.io.IOException

class WVa : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        view1 = findViewById(R.id.CGView)
    ...
    private fun getUrl(): String {
        ...
        val mainid: String = Hawk.get(Constants.MAIN_ID)

        val cpOne: String? = Hawk.get(CAMP1)
        val cpTwo: String? = Hawk.get(CAMP2)
        val cpThree: String? = Hawk.get(CAMP3)

        val dpOne: String? = Hawk.get(DEEP1)
        val dpTwo: String? = Hawk.get(DEEP2)
        val dpThree: String? = Hawk.get(DEEP3)


        val pack = "com.my.hc.rpg.kingdom.simulato0"
        ...
        val first = "https://"
        val second = "celestialgriffin.site/7hXhn"
